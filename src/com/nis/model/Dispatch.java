...
public class Dispatch {
	...
	private String charge_Of_Dispatch;
	private String dispatch_From;
	private String dispatch_To;
	private String dispatch_By;
	private String veichel_No;
	private String approxdays;
	...
	public String getCharge_Of_Dispatch() {
		return charge_Of_Dispatch;
	}
	public void setCharge_Of_Dispatch(String charge_Of_Dispatch) {
		this.charge_Of_Dispatch = charge_Of_Dispatch;
	}
	...
	public String getVeichel_No() {
		return veichel_No;
	}
	public void setVeichel_No(String veichel_No) {
		this.veichel_No = veichel_No;
	}
	public String getApproxdays() {
		return approxdays;
	}
	public void setApproxdays(String approxdays) {
