...
/**
 * Servlet implementation class GetAllConsigneeJSON
 */
@WebServlet("/GetAllConsigneeJSON")
public class GetAllConsigneeJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAllConsigneeJSON() {
        super();
