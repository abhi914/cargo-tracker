	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	 out.println (nav);		 
		 ...
		 out.println("<script src='asset/jquery-2.2.1.min.js'></script>");
	        ...
	        out.println("<tr>");
	        out.println("<td><b><i>Dob:</i></b></td><td><input type=text  required name=dob size=30></td>");
	        out.println("</tr>");
	        ...
	        out.println("<tr>");
	        out.println("<td><b><i>Photograph:</i></b></td><td><input type=file required name=photograph></td>");
	        out.println("</tr>");
